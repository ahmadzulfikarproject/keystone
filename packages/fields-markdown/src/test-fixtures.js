...
export const filterTests = withKeystone => {
  ...
  test(
    'Filter: content_ends_with',
    withKeystone(({ keystone }) =>
      match(keystone, { content_ends_with: '~~' }, [{ name: 'c', content: '~~Strike through~~' }])
    )
  );

  test(
    'Filter: content_not_ends_with',
    withKeystone(({ keystone }) =>
      match(keystone, { content_not_ends_with: '~~)' }, [
        { name: 'a', content: '**this is bold**' },
        { name: 'b', content: 'This is a [link](https://keystonejs.com)' },
        { name: 'c', content: '~~Strike through~~' },
        { name: 'd', content: '**This is BOLD**' },
